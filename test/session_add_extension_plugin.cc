...
NAN_METHOD(create) {
  ...
  libtorrent_rasterbar::PluginStorage* tpc = Nan::ObjectWrap::Unwrap<libtorrent_rasterbar::PluginStorage>(obj);
  tpc->Reset(boost::shared_ptr<libtorrent::plugin>(new libtorrent::plugin()));
